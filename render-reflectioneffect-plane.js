...
uniform vec4 iMouse;
uniform vec2 u_resolution;                                                                                          //add here                                                               
uniform vec2 u_mouse;                                                                                               //add here   
uniform float u_time;                                                                                               //add here   
...
// Plane and Sphere Definitions                                                                                             //add this part
...
Hit intersectPlane(Ray ray, vec3 normal, float d, vec3 color) {                                                          //add this part
...
void main() {
    ...
    // Camera setup                                                                                                          //add this part
    vec3 ro = vec3(0.0, 0.0, 2.0);
    vec3 rd = normalize(vec3(uv, -1.0));                                                                                     //end here
    ...
    plane0.material.reflectivity = 0.5;  // Adjust this value for stronger/weaker reflection                                //add here
