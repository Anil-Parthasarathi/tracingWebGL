...
#define NUMITEMS 5  // total items in the scene.
#define NOL0 7
#define NOL1 7
...
void main() {
    ...
    sphere1.position = vec3( 1800.0, -200.0, -mint0 / 4.5);
    sphere1.property = 1;
    ...
    sphere2 = sphere0;
    sphere2.material.diffuse = vec4(0.0/255.0, 255.0/255.0,0.0/255.0,1.0);
    ...
    sphere3 = sphere0;
    sphere3.material.diffuse = vec4(0.0/255.0, 255.0/255.0,0.0/255.0,1.0);
